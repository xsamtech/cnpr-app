...
@csrf
                                                <h4 class="h4 mt-3 mb-4 text-center fw-bold">@lang('miscellaneous.pages_content.admin.role.managers.add')</h4>
                                ...
                                <div class="col-lg-7 col-sm-6">
                                    <div class="card rounded-4">
                                        <div class="card-header">
                                            <h5 class="card-title m-0">@lang('miscellaneous.pages_content.admin.role.managers.list')</h5>
                                        </div>
                                            ...
                                            <li class="list-group-item ps-1">
                                                <div class="dropdown show float-end">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dataLink">
                                                        <a class="dropdown-item" href="{{ route('role.entity.datas', ['entity' => 'managers', 'id' => $manager->id]) }}">@lang('miscellaneous.change')</a>
                                                        <a class="dropdown-item" href="{{ route('delete', ['entity' => 'user', 'id' => $manager->id]) }}">@lang('miscellaneous.delete')</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-2 col-3">
                                                        <div class="bg-image">
                                                            <img src="{{ !empty($manager->avatar_url) ? $manager->avatar_url : asset('assets/img/user.png') }}" alt="" width="70" class="rounded-4">
                                                            <div class="mask"></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-10 col-9 d-flex justify-content-start align-items-center">
                                                        <span>
                                                            <h5 class="h5 m-0">{{ $manager->firstname . ' ' . $manager->lastname }}</h5>
                                                            <p class="small text-muted">{{ !empty($manager->username) ? '@' . $manager->username : (!empty($manager->email) ? $manager->email : $manager->phone) }}</p>
                                                        </span>
                                                    </div>
                                                </div>
                                            </li>
