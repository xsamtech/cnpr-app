                ...
                <section class="pt-4 pb-5">
                    <div class="section__content section__content--p30">
                        <div class="container-fluid">
                            <form method="POST" action="{{ route('role.entity.datas', ['entity' => 'managers', 'id' => $manager->id]) }}">
@csrf
                                <input type="hidden" name="user_id" value="{{ $manager->id }}">
                                <div class="d-flex justify-content-between">
                                    <h3 class="h3 fw-bold">@lang('miscellaneous.pages_content.admin.role.managers.edit')</h3>

                                    <!-- Status -->
                                    <div class="form-check form-switch pt-2">
                                        <input type="checkbox" role="switch" name="status_id-{{ $manager->id }}" id="status_id-{{ $manager->id }}" class="form-check-input" value="{{ $manager->status->id }}" onchange="changeStatus('user', this)" data-cnpr-status="{{ $manager->status->status_name }}"{{ $manager->status->status_name == 'Actif' ? ' checked' : '' }}>
                                        <label class="form-check-label align-bottom text-{{ $manager->status->color }}" for="status_id-{{ $manager->id }}" style="margin-top: -7px;"><i class="{{ $manager->status->icon }} me-1 cnpr-align-middle fs-4"></i>{{ $manager->status->status_name }}</label>
                                    </div>
                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row mb-3">
                                                    <div class="col-lg-6 mx-auto">
                                                        <!-- Role -->
                                                        <div class="input-group" title="@lang('miscellaneous.pages_content.admin.role.managers.change_role_description', ['administrateur' => ($manager->gender == 'F' ? 'administratrice' : 'administrateur'), 'de_lui' => ($manager->gender == 'F' ? 'd\'elle' : 'de lui'), 'il' => ($manager->gender == 'F' ? 'elle' : 'il'), 'un' => ($manager->gender == 'F' ? 'une' : 'un')])" data-bs-toggle="tooltip" data-bs-placement="top">
...
@foreach ($roles as $role)
                                                                <option value="{{ $role->id }}"{{ $manager->roles[0]->id == $role->id ? ' selected' : '' }}>
                                                ...
                                                <div class="row g-3 mb-3">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="form-floating">
                                                            <input type="text" name="register_number" id="register_number" class="form-control" placeholder="@lang('miscellaneous.number')" value="{{ $manager->number }}" autofocus />
                                                    ...
                                                    <div class="col-lg-6">
                                                        <!-- First name -->
                                                        <div class="form-floating">
                                                            <input type="text" name="register_firstname" id="register_firstname" class="form-control" placeholder="@lang('miscellaneous.firstname')" aria-describedby="firstname_error_message" value="{{ $manager->firstname }}" />
...
@endif
                                                ...
                                                <div class="row g-3 mb-3">
                                                    <div class="col-lg-6">
                                                        <!-- Last name -->
                                                        <div class="form-floating">
                                                            <input type="text" name="register_lastname" id="register_lastname" class="form-control" placeholder="@lang('miscellaneous.lastname')" value="{{ $manager->lastname }}" />
                                                    ...
                                                    <div class="col-lg-6">
                                                        <!-- Surname -->
                                                        <div class="form-floating">
                                                            <input type="text" name="register_surname" id="register_surname" class="form-control" placeholder="@lang('miscellaneous.surname')" value="{{ $manager->surname }}" />
                                                ...
                                                <div class="row g-3 mb-3">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="row g-sm-2 g-2">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <div class="form-floating">
                                                                    <input type="text" name="register_birth_city" id="register_birth_city" class="form-control" placeholder="@lang('miscellaneous.birth_city')" value="{{ $manager->birth_city }}" />
                                                            ...
                                                            <div class="col-sm-5">
                                                                <div class="form-floating mt-sm-0 mt-2">
                                                                    <input type="text" name="register_birth_date" id="register_birthdate" class="form-control" placeholder="@lang('miscellaneous.birth_date.label')" value="{{ !empty($manager->birth_date) ? str_starts_with(app()->getLocale(), 'fr') ? \Carbon\Carbon::createFromFormat('Y-m-d', $manager->birth_date)->format('d/m/Y') : \Carbon\Carbon::createFromFormat('Y-m-d', $manager->birth_date)->format('m/d/Y') : null }}" />
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="text-center">
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="register_gender" id="male" value="M"{{ $manager->gender == 'M' ? ' checked' : '' }}>
                                                                <label class="form-check-label" for="male">@lang('miscellaneous.gender1')</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="register_gender" id="female" value="F"{{ $manager->gender == 'F' ? ' checked' : '' }}>
                                                ...
                                                <div class="row g-3 mb-3">
                                                    <div class="col-lg-6">
                                                        <!-- Username -->
                                                        <div class="form-floating">
                                                            <input type="text" name="register_username" id="register_username" class="form-control" placeholder="@lang('miscellaneous.username.label')" aria-describedby="username_error_message" value="{{ $manager->username }}" />
...
@endif
                                                    ...
                                                    <div class="col-lg-6">
                                                        <!-- Phone -->
                                                        <div class="form-floating">
                                                            <input type="text" name="register_phone" id="register_phone" class="form-control" placeholder="@lang('miscellaneous.phone')" aria-describedby="phone_error_message" value="{{ $manager->phone }}" />
...
@endif
                                                ...
                                                <div class="row g-3 mb-3">
                                                    <div class="col-lg-6">
                                                        <!-- E-mail -->
                                                        <div class="form-floating">
                                                            <input type="text" name="register_email" id="register_email" class="form-control" placeholder="@lang('miscellaneous.email')" value="{{ $manager->email }}" />
                                                    ...
                                                    <div class="col-lg-6">
                                                        <!-- P.O Box -->
                                                        <div class="form-floating">
                                                            <input type="text" name="register_p_o_box" id="register_p_o_box" class="form-control" placeholder="@lang('miscellaneous.p_o_box')" value="{{ $manager->p_o_box }}" />
                                                ...
                                                <div class="row g-3 mb-3">
                                                    <div class="col-lg-6 mx-auto">
                                                        <!-- Office -->
                                                        <div class="form-floating">
                                                            <input type="text" name="register_office" id="register_office" class="form-control" placeholder="@lang('miscellaneous.office')" value="{{ $manager->office }}" />
                                                ...
                                                <div class="row g-3 mb-3">
                                                    <div class="col-lg-6">
                                                        <!-- Address line 1 -->
                                                        <div class="form-floating">
                                                            <textarea name="register_address_1" id="register_address_1" class="form-control" placeholder="@lang('miscellaneous.address.line1')">{{ $manager->address_1 }}</textarea>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <!-- Address line 2 -->
                                                        <div class="form-floating">
                                                            <textarea name="register_address_2" id="register_address_2" class="form-control" placeholder="@lang('miscellaneous.address.line2')">{{ $manager->address_2 }}</textarea>
...
@endif
                                ...
                                <div class="row g-sm-3 g-2">
                                    ...
                                    <div class="col-lg-3 col-sm-4 me-sm-auto">
                                        <a href="{{ route('role.entity.home', ['entity' => 'managers']) }}" class="btn btn-light btn-block border rounded-pill">@lang('miscellaneous.cancel')</a>
                                    </div>
                                </div>
                            </form>
                        </div>
