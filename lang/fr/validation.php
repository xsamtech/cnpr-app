...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'username' => [
            'exists' => 'Ce pseudo existe déjà. Veuillez choisir un autre s\'il vous plait.'
        ],
        'province_name' => [
            'exists' => 'Cette province est déjà enregistrée'
        ],
        'city_name' => [
            'exists' => 'Cette ville est déjà enregistrée pour cette province'
        ],
        'group_name' => [
        ...
        'file_url' => [
            'exists' => 'Ce lien vers le fichier existe déjà'
        ],
        'branch_name' => [
            'exists' => 'Ce nom d\'antenne existe déjà'
        ],
        'department_name' => [
            'exists' => 'Ce nom de département existe déjà'
        ],
        'content' => [
        ...
        'day_month' => [
            'exists' => 'Ce jour/mois existe déjà pour cette année'
        ],
        'owner' => [
